...
function findScriptSection() {
    $(function() {
        ...
        $.getScript(g, function(a, e, g) {
            3 <= c.length && (_WidgetManager._Init(c[0], c[1], c[2] + ""), _WidgetManager._RegisterWidget("_ContactFormView", new _WidgetInfo("ContactForm2", "ft4", null, document.getElementById("ContactForm2"), {
                ...
                contactFormEmptyMessageMsg: "\u0e0a&#3656;\u0e2d\u0e07\u0e02&#3657;\u0e2d\u0e04\u0e27\u0e32\u0e21\u0e08\u0e30\u0e15&#3657;\u0e2d\u0e07\u0e44\u0e21&#3656;\u0e40\u0e27&#3657;\u0e19\u0e27&#3656;\u0e32\u0e07",
                title: "Contact Us",
                blogId: "233816824204858149",
                contactFormNameMsg: "\u0e0a&#3639;&#3656;\u0e2d",
                contactFormEmailMsg: "\u0e2d&#3637;\u0e40\u0e21\u0e25",
