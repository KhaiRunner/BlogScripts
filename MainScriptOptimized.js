...
function D(){
	var directInfo = "เลือกเตียงนอนแบบไหนกันดี มาดูกันดีกว่า,โปรเซเว่น & โบรชัวร์ประจำวันที่ 14 - 20 มีนาคม 2562,Space Inspirium ที่เที่ยวสนุกๆ ว่างๆไปเที่ยวได้,รีวิว 7 Seas Pattaya/Sonia Residence สวนน้ำดีๆ ราคาเบาๆ,โปรโมชั่นสงกรานต์ ห้างแม็คโคร มีอะไรน่าสนใจ มาเช็คราคากัน,/2019/03/tips-choose-your-bed.html,/2019/03/7-11-promotion-14-20Mar.html,/2019/03/one-day-trip-Space-Inspirium.html,/2019/03/review-7-Seas-Pattaya-and-Sonia-Residence.html,/2019/03/Songkran-promotion-at-Makro.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://1.bp.blogspot.com/-bvCwrksEA88/XIn0uzU68VI/AAAAAAABj6I/d1fnejYJlBACjW3bwEHSBXulhkizgRg-wCLcBGAs/s1600/r.png';
