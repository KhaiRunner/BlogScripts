...
function D(){
	var directInfo = "101 แบบห้องน้ำสวยๆ โมเดิร์น น่าใช้งาน,ไอเดียแต่งห้องนั่งเล่นประหยัดๆ สวยงาม อารมณ์สบายๆ,102 แบบห้องครัวสวยๆ ตามหาห้องครัวโมเดิร์นที่โดนใจคุณ,แบบห้องนั่งเล่นสีส้ม สีเขียว สีแดง สีน้ำตาล ชอบสีไหน?!,แบบห้องครัวเปิดโล่ง สวย หรู ดูมีระดับ,/2019/05/101-modern-bathroom-designs.html,/2019/05/save-money-interior-living-room-designs.html,/2019/05/102-modern-cozy-kitchen-designs.html,/2019/05/modern-living-room-colors.html,/2019/05/open-space-kitchen-design.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://4.bp.blogspot.com/-SFVNm-LfTRM/XN0B4k6KDrI/AAAAAAABn_s/i4v-a-ES2pUTCGEsPXvQfH6Wi96O1lCKQCLcBGAs/s1600/r.png';
