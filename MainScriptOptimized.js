...
function G(){
	...
	document.getElementById('sbC').innerHTML = F(beforeAdHtml);
	
	//sb2 -> Left hand
	//sb3 -> Under Ad
	var elementIdForLeftSidebar = B>1200?'sb2':'sb3';
	document.getElementById(elementIdForLeftSidebar).innerHTML = F(htmlLeftSidebar);
