...
function D(){
	var directInfo = "ไอเดียแต่งระเบียงคอนโด มาดูตัวอย่างในชีวิตจริงกัน,ไม้จิ้มฟันนั้นไซร้ คือ ของแต่งบ้านสุดอลังการ!!!,แต่งบ้านโมเดิร์น บรรยากาศสดใส ดูดี น่าอยู่,70 ไอเดียแต่งที่นั่งเล่นระเบียงหน้าบ้าน ดูตัวอย่างกัน,18 ตัวอย่างติดผ้าม่านตาไก่ จะสวยไหม มาดูกันเลย,/2019/05/balcony-condo-decoration-ideas.html,/2019/05/DIY-decorate-items-from-Toothpick.html,/2019/05/modern-interior-home-example.html,/2019/05/70-decor-ideas-for-front-porch.html,/2019/05/eyelet-curtains-ideas.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://3.bp.blogspot.com/-iw1_JTezCbg/XOUAUUJyNZI/AAAAAAABpCM/RqmnkPNdUqYjeFMASsRCWugZpHlHXDlvwCLcBGAs/s1600/r.png';
