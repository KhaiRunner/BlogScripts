...
function D(){
	var directInfo = "ไอเดียแต่งคอนโดแนวลอฟท์ โดดเด่นไม่ซ้ำใคร,แต่งตึกแถวให้กลายเป็นบ้านที่น่าอยู่ โมเดิร์นมากๆ,แต่งคอนโดโมเดิร์นสวยๆ ทาสีห้องไม่ซ้ำกัน,แต่งคอนโดโมเดิร์น สวย เก๋ไม่ซ้ำใคร กับโทนสีฟ้าสวยๆ,300 แบบห้องนั่งเล่นสวยๆ ดูไอเดียแต่งบ้านกัน,/2019/05/cozy-condo-interior-with-loft-style.html,/2019/05/cozy-commercial-building-interior-idea.html,/2019/05/colurful-modern-condo-interior.html,/2019/05/modern-condo-interior-with-blue-and-white-color.html,/2019/05/300-relax-living-room-designs.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://1.bp.blogspot.com/-IB2xxY1HWZw/XOee2BVhXJI/AAAAAAABp3c/9faTqDu3lpcb1ju_d0K-RVfYJfplfPw4gCLcBGAs/s1600/r.png';
