...
function D(){
	var directInfo = "ไอเดียแต่งห้องนอนพ่อแม่ลูก มาดูตัวอย่างเก๋ๆกันเลย,ไอเดียแต่งห้องนอนเล็กๆและเล็กมากๆ ให้น่าอยู่,แบบห้องน้ำแคบๆ พื้นที่เล็กๆแต่งห้องน้ำแบบไหนดี,ไอเดียแต่งระเบียงคอนโดสวยๆ ดูตัวอย่างเยอะเลย,ตัวอย่างแต่งห้องน้ำเล็กๆ ให้ดูกว้าง น่าใช้ แนวโมเดิร์น,/2019/04/bedroom-designs-for-dad-mom-and-kids.html,/2019/04/small-bedroom-design-ideas.html,/2019/04/small-and-narrow-bathroom-designs.html,/2019/04/beautiful-balcony-decoration-ideas.html,/2019/04/small-modern-bathroom-design.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://1.bp.blogspot.com/-wNOUaE6yANA/XKLxBaLDnFI/AAAAAAABk5c/map8h0q7_BslyW-j8EBFPe4XMI5f7swJACLcBGAs/s1600/r.png';
