...
function D(){
	var directInfo = "จุดชมวิวพัทยา นั่งจิบกาแฟ บรรยากาศชิวๆ,Promotion เทสโก้ โลตัส สำหรับวันที่ 14-20 มี.ค. 62,เลือกเตียงนอนแบบไหนกันดี มาดูกันดีกว่า,โปรเซเว่น & โบรชัวร์ประจำวันที่ 14 - 20 มีนาคม 2562,Space Inspirium ที่เที่ยวสนุกๆ ว่างๆไปเที่ยวได้,/2019/03/view-point-at-pattaya.html,/2019/03/promotion-tesco-lotus-14-20Mar.html,/2019/03/tips-choose-your-bed.html,/2019/03/7-11-promotion-14-20Mar.html,/2019/03/one-day-trip-Space-Inspirium.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://2.bp.blogspot.com/-5TVJksTjRzc/XIsX5qw7SRI/AAAAAAABj9s/8pQjex4XpooDegzQzix_b9YezTmYEb7XACLcBGAs/s1600/r.png';
