...
function D(){
	var directInfo = "ไอเดียบ้านไม้สวยๆ หลังเล็ก น่ารัก แต่งบ้านไม้น่าอยู่,ตัวอย่างแต่งห้องนอนบ้านไม้เก่าๆ มาดูกันเลย,ตกแต่งบันไดบ้านสวยๆ ดูดี มีสไตล์เฉพาะตัว,วิธีโกนหนวดให้สิวไม่ขึ้น ชีวิตจะได้ไม่น่าเบื่ออีก,เปรียบเทียบเครื่องฟอกอากาศ Xiaomi vs Sharp ใครดีกว่ากัน,/2019/04/cosy-small-wooden-house-designs.html,/2019/04/decorate-bedroom-in-wooden-house-ideas.html,/2019/04/decor-stair-ideas.html,/2019/04/How-to-shaving-and-prevent-acne.html,/2019/04/Air-purifier-Xiaomi-Pro-VS-Sharp.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://1.bp.blogspot.com/-TVR0hEPw6FQ/XL1pO43IOPI/AAAAAAABl90/ZkNFWclI9T4N6gtN5QhU9Q4D7MzXH0-mgCLcBGAs/s1600/r.png';
