...
function D(){
	var directInfo = "แบบบ้านชั้นครึ่งโมเดิร์นมากๆ อารมณ์บ้านใต้ถุนสูง,วิธีจัดสวนแนวตั้ง + ตัวอย่าง ทำเองกันได้ มาดูไอเดียกัน,ตัวอย่างจัดสวนแนวตั้งสวยๆ ร่มรื่นสุดๆ บ้านน่าอยู่,แบบบ้านสไตล์วินเทจ บ้านสวยๆ บรรยากาศสบายๆ,แบบเพดานไม้สุดสวย แต่งบ้านให้ผ่อนคลาย น่าอยู่,/2019/04/modern-1.5-storey-house-design-ideas-with-interior-picture.html,/2019/04/how-to-create-a-vertical-garden.html,/2019/04/vertical-garden-example.html,/2019/04/cozy-house-design-with-vintage-style.html,/2019/04/Beautiful-wooden-ceiling.html,,,,,";
...
function G(){
	//i -> image url.
	var recentlyImageUrl = 'https://3.bp.blogspot.com/-Y4qUk-nI6NA/XL6pIcsN0jI/AAAAAAABmPw/NFsXQowGBUAbY8pV_0_JakEKn62phLPfwCLcBGAs/s1600/r.png';
